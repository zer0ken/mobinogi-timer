...
### 패킷 타입 번호 변경 (게임 업데이트 대응)
- START_MARKER: `83 4E 00...` (이전: `82 4E 00...`)
- END_MARKER: `1A 4F 00...` (이전: `18 4F 00...`)
- SELF_DAMAGE 타입: 20919 → 20937
- BUFF_START 타입: 100055 → 110055
- field[16:20] 엠블럼 키 값 변경 없음
