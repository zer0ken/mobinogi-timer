...
엠블럼 각성을 패킷 캡처로 자동 감지하여, 전투 중 각성이 발동되면 즉시 오버레이 타이머가 동작합니다.

https://github.com/user-attachments/assets/15ec4342-dac7-45d7-9cfb-495a3172d6cd

## 기능

- **자동 각성 감지** — 패킷 캡처를 통해 엠블럼 각성 발동을 자동으로 감지합니다.
- **엠블럼별 지속시간** — 대마법사, 흩날리는 검, 갈라진 땅 등 엠블럼에 맞는 지속시간을 자동 적용합니다.
